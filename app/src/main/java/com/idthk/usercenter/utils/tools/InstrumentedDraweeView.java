...
public class InstrumentedDraweeView extends SimpleDraweeView implements Instrumented {
	...
	private Instrumentation1 mInstrumentation;
	...
	private void init() {
		mInstrumentation = new Instrumentation1(this);
	...
	public void setImageURI(Uri uri, @Nullable Object callerContext) {
		SimpleDraweeControllerBuilder controllerBuilder = FrescoConfig.getSimpleDraweeControllerBuilder(getControllerBuilder(), uri, callerContext, getController());
