...
//
///**
// * Created by williamyin on 2017/12/22.
// */
//
...
////                            if (mPermissionsChecker.lacksPermissions(UtilTools.PERMISSIONS)) {
...
//                try {
//                    if (isClickCamera) {
//                        Log.i("onActivityResdult: ", "11"+imageUri.toString());
//                        bitmap = BitmapFactory.decodeStream(getContentResolver().openInputStream(imageUri));
//                    } else {
//                        Log.i("onActivityResdult: ", "22"+imagePath);
...
//            imageUri = FileProvider.getUriForFile(this, "com.idthk.globeuser.fileprovider", file);//通过FileProvider创建一个content类型的Uri
//        } else {
